...
using MysqlEntityStarter.Entities;
...
namespace ChinookExercice
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var line in GetInvoiceLines(context, 1))
            {
                Console.WriteLine($"{line.Track.Name} {line.UnitPrice} {line.Quantity}");
            }

            // Pour un id de commande
            // Afficher le nom de la piste, le prix et la quantité achetés
        ...
        private static IEnumerable<InvoiceLine> GetInvoiceLines(ChinookContext context, int invoiceId)
        {
            return context.InvoiceLines
                .Include(i => i.Track)
                .Include(i => i.Track.Album)
